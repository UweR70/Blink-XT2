  ...
  <li>
   ...
   Like:
    <ul>
      ...
      <li>
        A <a href="https://github.com/UweR70/Blink-XT2/wiki/Tutorial:-How-to-decompile-an-apk%3F">Tutorial: How to decompile an apk?</a> that demonstrates step-by-step how to get the <b>code</b> of the <b>original Blink mobile phone app</b> - which also contains the API calls mentioned above.<br>
      </li>
    </ul>
  </li>
</ul>
